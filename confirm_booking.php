    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 my-5 mb-4 px-4">
                <h2 class="h-font fw-bold">Confirm Booking</h2>
                        ...
                        <form action="#" id="booking_form">
                            ...
                            <div class="row">
                                ...
                                <div class="col-12">
                                    ...
                                    <button name="confirm" class="btn w-100 text-white custom-bg shadow-none mb-1">Confirm Booking</button>
                                </div>
                            </div>
                        </form>
                    </div>
